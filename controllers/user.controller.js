...
class UserController {
  ...
  static signup(req, res, err) {

    if (req.body.firstName && req.body.lastName && req.body.username && req.body.password && req.body.confirmPassword) { // eslint-disable-line
